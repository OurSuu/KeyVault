...
// ====== Brevo API Client Setup (with Detailed Checks) ======
console.log("--- DEBUG: Attempting to require @getbrevo/brevo ---");
const SibApiV3Sdk = require('@getbrevo/brevo');
console.log("--- DEBUG: require('@getbrevo/brevo') successful ---");

// 1. Check if SibApiV3Sdk.ApiClient exists
if (!SibApiV3Sdk || typeof SibApiV3Sdk !== 'object' || !SibApiV3Sdk.ApiClient) {
    console.error("<<<<< FATAL: SibApiV3Sdk.ApiClient is MISSING or NOT an object! >>>>>");
    console.error("--- DEBUG: SibApiV3Sdk object received:", SibApiV3Sdk); // Log structure
    throw new Error("Brevo SDK structure mismatch: ApiClient property not found.");
}
console.log("--- DEBUG: SibApiV3Sdk.ApiClient check PASSED ---");

// 2. Check if SibApiV3Sdk.ApiClient.instance exists
if (!SibApiV3Sdk.ApiClient.instance) {
    console.error("<<<<< FATAL: SibApiV3Sdk.ApiClient.instance is MISSING! >>>>>");
    console.error("--- DEBUG: SibApiV3Sdk.ApiClient:", SibApiV3Sdk.ApiClient); // Log ApiClient structure
    throw new Error("Brevo SDK structure mismatch: ApiClient.instance property not found.");
}
console.log("--- DEBUG: SibApiV3Sdk.ApiClient.instance check PASSED ---");
const apiClientInstance = SibApiV3Sdk.ApiClient.instance;

// 3. Check if authentications['api-key'] exists
if (!apiClientInstance.authentications || typeof apiClientInstance.authentications !== 'object' || !apiClientInstance.authentications['api-key']) {
    console.error("<<<<< FATAL: apiClientInstance.authentications['api-key'] is MISSING! >>>>>");
    console.error("--- DEBUG: apiClientInstance.authentications:", apiClientInstance.authentications); // Log authentications structure
    throw new Error("Brevo SDK structure mismatch: authentications['api-key'] not found.");
}
console.log("--- DEBUG: authentications['api-key'] check PASSED ---");
const apiKeyAuth = apiClientInstance.authentications['api-key'];

// 4. Set the API Key
apiKeyAuth.apiKey = process.env.BREVO_API_KEY;
console.log("--- DEBUG: API Key has been set ---");

// 5. Check if SibApiV3Sdk.TransactionalEmailsApi exists
if (typeof SibApiV3Sdk.TransactionalEmailsApi !== 'function') {
     console.error("<<<<< FATAL: SibApiV3Sdk.TransactionalEmailsApi is NOT a function! >>>>>");
     console.error("--- DEBUG: SibApiV3Sdk.TransactionalEmailsApi:", SibApiV3Sdk.TransactionalEmailsApi);
     throw new Error("Brevo SDK structure mismatch: TransactionalEmailsApi class not found.");
}
console.log("--- DEBUG: TransactionalEmailsApi check PASSED ---");
const brevoApi = new SibApiV3Sdk.TransactionalEmailsApi();
console.log("--- DEBUG: brevoApi instance created successfully ---");
// ===================================================
