...
// ====== Brevo API Client Setup (Final Correct Way) ======
const SibApiV3Sdk = require('@getbrevo/brevo');

// 1. เข้าถึง Singleton instance ของ ApiClient
const apiClientInstance = SibApiV3Sdk.ApiClient.instance;

// 2. กำหนด Authentication ชื่อ 'api-key'
const apiKeyAuth = apiClientInstance.authentications['api-key'];

// 3. ตั้งค่า API Key บน Authentication นั้น
apiKeyAuth.apiKey = process.env.BREVO_API_KEY;

// 4. สร้าง Instance ของ API ที่จะใช้ (หลังจากตั้ง Key แล้ว)
